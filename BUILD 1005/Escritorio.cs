...
namespace SolSpaceOS
{
    public partial class Act : Form
    {
        ...
        private void Escritorio_Load(object sender, EventArgs e)
        {
            ...
            start.Play();
            label1.Text = "ESTO ES UN SIMULADOR DE SISTEMA OPERATIVO NO REAL BUILD 1005";
        ...
        {
            MessageBox.Show("La tienda no está disponible por el momento.");
        }
